export const financeLandingFallback = {
  ...
  softwareTools: {
    ...
    items: [
      ...
      },
      {
        _key: "fieldwire",
        name: "Fieldwire",
        src: "/fieldwire-logo.svg",
      },
      {
        _key: "all-erp-systems",
        name: "All ERP Systems",
        textOnly: true,
      },
      {
        _key: "zoho-books",
  ...
  additionalServices: {
    title: "Beyond Inventory Management",
    description:
      "As your business grows, operational efficiency depends on more than just inventory. ARK Simplify also supports your finance and operations with services that keep your workflows connected, accurate, and running smoothly.",
    items: [
      {
      ...
      },
      {
        _key: "ap-ar",
        icon: "receivables",
        title: "Accounts Payable (AP) / Accounts Receivable (AR)",
      },
      {
        _key: "bookkeeping",
        icon: "bookkeeping",
